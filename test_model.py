"""
Tests for model.py — validates provider detection, parsing, and live Ollama queries.
...
Usage:
  ...
  pytest test_model.py -v -k live      # Run only live Ollama tests

Requires: Ollama running locally with qwen3:8b (or another model) pulled.
"""
